...
class Alumnus_company extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
		array('designation,company,IndustryId,jobNumber,country','length','max'=>40),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'alumnus' => array(self::HAS_MANY, 'Alumnus', 'alumnusId','together'=> true),			
	...
	public function getNotnull($arr){
		...
		if($arr->designation==NULL && $arr->company==NULL && $arr->IndustryId==0)
			return false;
		else 
			return true;
