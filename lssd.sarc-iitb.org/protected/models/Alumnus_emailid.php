...
class Alumnus_emailid extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'Id',
			'alumnusId' => 'alumnusId',
			'emailId1' => 'EmailId (Primary)',
			'emailId2' => 'EmailId (Secondary)',
			'emailId3' => 'EmailId (Other)',
		);
	}
