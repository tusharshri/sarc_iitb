...
class Alumnus_social extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('link1,link2,link3','length','max'=>100),
		);
	}
	...
	public function getNotnull($arr){
		...
		if($arr->link1==NULL && $arr->link2==NULL && $arr->link3==NULL && !isset($arr->alumnusId))
			return false;
		else 
			return true;
