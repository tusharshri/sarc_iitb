...
class Alumnus_mailed extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('mailed_for,response,phaseYear','type','type'=>'text'),
		);
	}
	...
	public function getNotnull($arr){
		...
		if($arr->mailed_for==0 && $arr->response==NULL && $arr->phaseYear==NULL)
			return false;
		else 
			return true;
