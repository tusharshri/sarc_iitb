...
class Alumnus extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('firstName,lastName,batch,department, hostel,gender', 'required'),
			...
			//array('dateofbirth','type', 'type' => 'date', 'message' => '{attribute}: is not a date!', 'dateFormat' => 'yyyy-MM-dd'),
	...
	public function relations()
	{
		...
		return array(
			...
			'mentorship_allotment'=>array(self::HAS_MANY, 'Mentorship_allotment', 'alumnusId','together'=> true),			
			'phonathon_allotment'=> array(self::HAS_MANY, 'Phonathon_allotment', 'alumnusId','together'=> true),
			'phonathon_calldetail'=> array(self::HAS_MANY, 'Phonathon_calldetail', 'alumnusId','together'=> true),
			'phonathon_calllog'=> array(self::HAS_MANY, 'Phonathon_calllog', 'alumnusId','together'=> true),			
