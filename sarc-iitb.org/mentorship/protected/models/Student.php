...
class Student extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
            ...
            array('emailId,emailId2', 'email'),
            array('ldapId, phoneNumber, skypeId', 'length', 'max'=>32),
            array('salutation, gender, departmentCode, roomNumber', 'length', 'max'=>8),
			array('firstName, middleName, nickName, skypeId, lastName, nickName, emailId,emailId2', 'length', 'max'=>64),
			array('hostel', 'length', 'max'=>10),
            array('dateOfBirth, emailId2, createdAt', 'safe'),
	...
	public function relations()
	{
		...
		return array(
			...
			'mentorshipConnections1' => array(self::HAS_MANY, 'MentorshipConnection', 'alloterId'),//TODO:Change the relation to team
			'phonathonVolunteers' => array(self::HAS_MANY, 'PhonathonVolunteer', 'studentId'),
			'mentorshipPreferences' => array(self::HAS_MANY, 'StudentMentorshipPreference', 'studentId'), 
            'preferenceLists' => array(self::HAS_MANY, 'StudentPreferenceList', 'studentId'),
			...
			'outbox'=>array(self::HAS_MANY, 'Sendmessage_student', 'studentId', 'together'=> true),
			'inbox'=>array(self::HAS_MANY, 'Sendmessage_alumnus', 'studentId', 'together'=> true),
			'remarks' => array(self::HAS_MANY, 'StudentRemark', 'studentId'),
			'remarksMade' => array(self::HAS_MANY, 'StudentRemark', 'remarkedBy'),
            'registrations' => array(self::HAS_MANY, 'StudentRegistration', 'studentId','together'=>true),
            // check it
