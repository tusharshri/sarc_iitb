 ...
 *
 * The followings are the available columns in table 'RoleAssignment':
 * @property integer $id
...
class RoleAssignment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('roleId, loginId', 'required'),
			array('roleId, loginId', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, roleId, loginId', 'safe', 'on'=>'search'),
		);
	}
