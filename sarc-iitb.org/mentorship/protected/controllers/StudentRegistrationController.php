...
class StudentRegistrationController extends Controller
{
    ...
    public function actionError()
  {
    ...
    private function isauthorized($studentId,$step){
        if(Yii::app()->user->isGuest){
            ...
            $mRegistration=StudentRegistration::model()->findByAttributes(array('studentId'=>Yii::app()->user->id,'phaseYear'=>'02_2013'));
      ...
      // validate user input and redirect to the previous page if valid
            ...
            if($model->validate() && $model->register()){
                ...
                if($user->save()){
                    ...
                    $registration=StudentRegistration::model()->findByAttributes(array("phaseYear"=>"02_2013",'studentId'=>$user->id));//echo"sa";print_r($registration);
                    if($registration!=null){
                        if($registration->step==6){
                            if(MentorshipConnection::model()->exists('studentId='.$user->id.' AND phaseYear=\'02_2013\'')){
                        ...
                        $registration->phaseYear="02_2013";
  ...
  public function actionSop()
  {
        ...
        if($this->isauthorized($studentId,2)){
            //$mStudent=Student::model()->with(array('registrations',array('condition'=>array('phaseYear'=>'02_2013'))))->findByPk($studentId);
            $mRegistration=StudentRegistration::model()->findByAttributes(array('studentId'=>Yii::app()->user->id,'phaseYear'=>'02_2013'));
            $mResume = new Resume;
            if(isset($_POST['Resume'])){
                ...
                if($mRegistration->sop==""){
                  ...
                  if($mRegistration->validate() && $mResume->validate()){  // add && $mResume->validate() to validate resume
                        $mRegistration->save();
                        $this->changeStep(3);
