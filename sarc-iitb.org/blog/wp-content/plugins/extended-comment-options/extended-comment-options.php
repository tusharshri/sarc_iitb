...
/**
 * Feeback form to try to capture why people are downloading this plugin
 */
function eco_feedback_form() {
    ?>
    <iframe src="https://docs.google.com/spreadsheet/embeddedform?formkey=dE9JQzFrSC1LaXhrS1YzS0tYb3BoaWc6MQ" width="100%" height="800px" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
    <?php
}
?>
