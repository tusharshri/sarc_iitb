      ...
      if(isset($_POST['sub'])){
        ...
        $sql="INSERT INTO cult_registrations (`name`,`batch`,`email`,`phonenum`) VALUES ('$name','$batch','$email',$phnum)";
                //echo $sql;
        ...
        if($query){
          ...
          if( strcmp(substr($e,0,9),"Duplicate") == 0){
            ...
            echo '<h3 style="padding:200px;">Try again there might be some error.</h3>';    
             ...
             <H1 style="margin-left:270px;"> Cult Meet 2012</H2> <br />
  ...
  <p style="padding-left:70px;padding-right:30px;line-height: 24px;word-spacing: 1.3px;" >   
         This is the first time ever when students and Alumni will be at same platform performing cult activites. <br/> Be there and enjoy !!!
<br>Cult meet is being jointly organised by Cult body & SARC.
<br><br>

              </p>
            <form action="cult_registration.php" method="post">
            <table>
            <tr>
            <td>
            <label>Name</label> </td>
