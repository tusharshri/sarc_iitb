  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
		...
		<body> 
            ...
            <img src="image/hungama_bg1.png" style="width:175px; margin:25px 0 0 5px;" ><a/>
            <div style="margin: 5px 0px 0px 91px;
                 font-size: 13px;color:rgba(255, 255, 255, 0.6); color:; font-weight:bold;width:70px; ">
                 presents
                 </div>
                  </div>
