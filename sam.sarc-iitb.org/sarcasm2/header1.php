...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
		...
		<body style="background-image:url(http://www.w3schools.com/cssref/paper.gif);
background-repeat:repeat;"> 
			...
			<div id="head" class="container">
              ...
              <div style="float:left; margin-top:40px;
                 font-size: 25px;color:rgba(255, 255, 255, 0.6); ">
                 &
                 </div>
              <div style="float:left; " >
            <a href="http://www.hungama.com/"  target="_blank"  > 
            <img src="image/hungama_bg.jpg" style="height:70px; margin:25px 0 0 5px;" ><a/> </div>
            <div style="position:absolute; top:85px; left:430px;
                 font-size: 13px;color:rgba(255, 255, 255, 0.6); color:; font-weight:bold; ">
                 presents
                 </div>
              <div id="divider"> <img src="image/divider1.gif" style="height:90px; margin-top:10px; " /> </div>
                ...
                <span style="font-size:21px;  " >Student Alumni Meet 2012 </span> <br />
