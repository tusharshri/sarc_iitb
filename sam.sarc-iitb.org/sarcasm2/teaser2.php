...
<section class="slider-top" style="background: url(../images/bg.jpg) no-repeat center;background-size:auto 100%">
	<div class="row">
		<div class="twelve columns top-content">
			<h3>SARCasm</h3>
			<p style="font-size:40px;">Starts 27th September at 9 PM</p>
			<br><br><br>
			...
			<br>
			<br>
			<p style="font-size:18px;">Spot the Spot !!!</p>
			<br>
			<center><iframe width="420" height="315" src="//www.youtube.com/embed/gGV4hxhxW8o" frameborder="0" allowfullscreen></iframe></center>
			<center><img src="Teaser2.jpg" align="center" alt="teaser" height="200" width="200"></center>
			<?php
if($_GET['q']==done){
...
<center><span style="font-weight:bold; font-size:18px; color:#333;">Answer:</span></center> <input type="text" name="name" style="font-size:18px; color:#333;><br>
<input type="submit">
</form>
		</div>
