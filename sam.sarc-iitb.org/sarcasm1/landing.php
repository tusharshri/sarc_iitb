...
<section class="slider-top" style="background: url(../images/bg.jpg) no-repeat center;background-size:auto 100%">
	<div class="row">
		<div class="twelve columns top-content">
			<h3>SARCasm</h3>
			<p style="font-size:40px;">Starts 28th September at 9 PM</p>
			<br><br><br>
			<p><span id="countdown" style="font-size:100px;"></span></p>
			<p>Days &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hours &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Minutes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Seconds</p>
			<p style="font-size:30px;">to go...</p>
			<br>
...
<div id="foot" class="container" >
	...
	<div id="list " >
          ...
          <a href="../index.php">      <li class="last_li">Home</li> </a>
           ...
           <a href="../schedule.php">      <li class="last_li">Schedule</li> </a>
             <a href="../team.php">  <li class="last_li">Our Team</li></a> 
                </ul>
