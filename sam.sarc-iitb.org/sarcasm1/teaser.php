...
<section class="slider-top" style="background: url(../images/bg.jpg) no-repeat center;background-size:auto 100%">
	<div class="row">
		<div class="twelve columns top-content">
			...
			<img src="Teaser 1.jpg" align="center" alt="teaser" height="500" width="800">
			<?php
if($_GET['q']==done){
...
<center><span style="font-weight:bold; font-size:18px; color:#333;">Answer:</span></center> <input type="text" name="name"><br>
<input type="submit">
</form>
		</div>
