    ...
    public function actionRegister()
  {
    ...
    public function actionThankyou(){
        ...
        public function actionMentor(){
            ...
            //print_r($mStudent);
            if($mMentor=MentorshipConnection::model()->with(array('alumnus','alumnus.personalDetails','alumnus.department','alumnus.emailIds','alumnus.phoneNumbers','alumnus.profDetails'))->findByAttributes(array('studentId'=>$studentId,'phaseYear'=>'01_2013'))){
    ...
    public function actionHome(){
      ...
      if($mStudent=Student::model()->with(array(
                        'department',
                        'registrations'=>array('condition'=>'phaseYear=\'01_2013\''),))->findAllByAttributes(array('id'=>$studentId))){
    ...
    public function actionSendmessage(){
      $studentId=Yii::app()->session['studentId'];
            ...
            if($mAlumnus=MentorshipConnection::model()->with(array('alumnus'))->findAllByAttributes(array('studentId'=>$studentId,'phaseYear'=>'01_2013'))){
