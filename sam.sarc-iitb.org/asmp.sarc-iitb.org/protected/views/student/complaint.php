  ...
  <div class="profile">
      <div class="header">
        ...
        foreach($mStudents as $key=>$student){
          ...
          $studentemailid=$student->emailId;  
        }
                $to="sarc@iitb.ac.in";
                ...
                $headers .= "Reply-To: $studentemailid\r\n";
                ...
                if(mysql_query("INSERT INTO `complaintbox`( `roleId`,`role`,`title`, `description`) VALUES ('".$student->id."','student','".$subject."','".$message."'")){
