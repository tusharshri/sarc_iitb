...
<div id="container">
	...
	<div id="first_desp">
    	<div id="pic"><img src="<?php  
			$filename=$_SERVER{'DOCUMENT_ROOT'} .'/beta.mentorship/images/alumnus/'.$mAlumnus->id.'.jpg';
			$file2='../images/alumnus/'.$mAlumnus->id.'.jpg';
         ...
         //} ?>
          <?php } ?></div>
            ...
            <div class="font-type4">
            	Department : <?php echo $mAlumnus->departmentCode.' , '.$mAlumnus->degree; ?><br />
                BATCH : <?php echo $mAlumnus->class; ?>
            </div>
            <div id="special_desp">
            </div>
        </div>	
