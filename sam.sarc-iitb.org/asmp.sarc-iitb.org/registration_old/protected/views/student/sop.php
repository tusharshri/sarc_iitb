...
<h1>Upload Documents</h1>
    ...
    <div class="notification">
        ...
        <ul>
            ...
            <li>
                Resume is not for comparision between students but for efficient allotment of students to alumni by the ASMP team. Also, the same will be forwarded to your mentor as your background information.
            </li>
            <li>
