 ...
 */
class Alumnus extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array( // we can use attribute on to specify specific scenarios under which check should be followed
			...
			array('dateOfBirth','default','value'=>''),
	...
	public function relations()
	{
		...
		return array(
			'department' => array(self::BELONGS_TO, 'Department', 'departmentCode'),
