...
*/
    ...
    public function actionRegister()
  {
    ...
    public function actionMentorList(){
        $alumniList= Alumnus::model()->with(array('profDetails','profDetails.industry'))->findAll(array('condition'=>'t.id>2999'));
        $alumniProfList= AlumnusProfDetail::model()->findAll();
        $finalList=$alumniList;
        $alumniWeight=array();  
        foreach($alumniList as $alumnus){
    ...
    public function actionThankyou(){
        ...
        public function actionMentor(){
            ...
            //print_r($mStudent);
            if($mMentor=MentorshipConnection::model()->with(array('alumnus','alumnus.personalDetails','alumnus.department','alumnus.emailIds','alumnus.phoneNumbers','alumnus.profDetails'))->findByAttributes(array('studentId'=>$studentId,'phaseYear'=>'02_2012'))){
    ...
    public function actionHome(){
      ...
      if($mStudent=Student::model()->with(array(
                        'department',
                        'registrations'=>array('condition'=>'phaseYear=\'02_2012\''),))->findAllByAttributes(array('id'=>$studentId))){
    ...
    public function actionSendmessage(){
      $studentId=Yii::app()->session['studentId'];
            ...
            if($mAlumnus=MentorshipConnection::model()->with(array('alumnus'))->findAllByAttributes(array('studentId'=>$studentId,'phaseYear'=>'02_2012'))){
