    ...
    .hidden{
     ...
     <div class="notification">
        ...
        <ul>
			...
			<li>
                Please fill the following form to complete the online registration process: <a href="http://asmp.sarc-iitb.org/Student-Registration.html" target="_blank">http://asmp.sarc-iitb.org/Student-Registration.html</a>
            </li>
...
?>
         ...
         <div id="right">
          <span>Selection in order of Preference</span>
         <ol id="selected">

         </ol>
         <form id="submitPreference" name="submitPreference" action="submitPreference" method="post">
