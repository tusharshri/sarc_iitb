			...
			<div id="contentbody">
				<form action="<?php echo Yii::app()->baseUrl.'/alumnusregistration/step3/';  ?>" method="post">
					<table>
                        ...
                        <tr><td colspan=2><hr></td></tr>
						<tr>
							<td class="detailname">Work Profile and other details<span class="asterix">*</span><br/><span class="note" style="color:#F10">Please provide your work profile in as much detail as possible. Also, Tell us something interesting about yourself (professional and/or personal), your IITB experience, or your future plans. Students want to know more about you than your career field.Tell them about yourself here!</span></td>
							<td>
								<textarea id="workprofile" name="workprofile"><?php echo ''.$workprofile!=NULL ? $workprofile:'';?></textarea>
							</td>
						</tr>
						<tr>
							<td class="detailname">Describe the activities, interests, and/or hobbies that are most meaningful to you</td>
							<td>
								
								<textarea id="linkedin" name="linkedin"><?php echo ''.$linkedin!=NULL ? $linkedin:'';?></textarea>
							</td>
						</tr>
					</table>
