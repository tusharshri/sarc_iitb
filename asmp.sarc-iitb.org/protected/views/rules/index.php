<script type="text/javascript">
    ...
    function submit_button(){
         document.getElementById("submitbutton").innerHTML= '<?php echo CHtml::submitButton('Accept', array('name'=> 'Rules')); ?>';
...
<ol>
<li>The allotment will be done on the basis of students as well as
mentors preference. Once done the allotment will be final and the SARC
Team  will not entertain requests to change mentors.
</li>
<li>Mentors will be shown the profiles of the students who have
preferred him/her. This will help the  mentor in giving preference to
the mentees .Hence kindly fill all the details with care. Any
insulting or improper details will result in immediate
disqualification.
</li>
...
</li><li>SARC will be conducting a Student Alumni Meet (SAM) on 24th-25th
September. This will be the official Start of Mentee –Mentor
relationship. Attending it is imperative for those students whose
mentor is coming to the meet. Those students whose mentors can not
attend SAM will be given an opportunity to interact with other alumnus
via hostel interactions.
</li><li>SARC will be inviting all mentors. Only mentees of the attending
mentors will participate in the lunch.If any mentor can not make it to
SAM, sarc team will not be held liable for it .
</li></ol>
