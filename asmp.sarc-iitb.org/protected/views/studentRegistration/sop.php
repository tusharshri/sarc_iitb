...
<?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <?php echo $form->errorSummary(array($mRegistration)); ?>
    
  <div class="row">
    <?php echo $form->labelEx($mRegistration,'Mention your career interests, expectations out of this program and your mentor'); ?>
    <?php echo $form->textArea($mRegistration,'sop', array('cols'=>65 , 'rows'=>45)); ?>
    <?php echo $form->error($mRegistration,'sop'); ?>
  </div>

  <div class="row">
    <?php echo $form->labelEx($mResume,'resume (optional)'); ?>
