 ...
 */
class Sendmessage_student extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('studentId, alumnusId, title, message,sendAt', 'required'),
			...
			array('id, studentId, alumnusId, title, message, sendAt', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('studentId',$this->alumnusId);
		$criteria->compare('alumnusId',$this->studentId,true);
