...
class StudentMentorshipPreference extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('studentId, preferenceIndex', 'required'),
			array('studentId, preferenceIndex', 'numerical', 'integerOnly'=>true),
			array('preference', 'length', 'max'=>13),
            array('preference','default','setOnEmpty'=>true, 'value'=>"Technical"),
            array('preferredDepartmentCode','default','setOnEmpty'=>true, 'value'=>""),
            array('areaOfInterest','default','setOnEmpty'=>true, 'value'=>"Any"),
