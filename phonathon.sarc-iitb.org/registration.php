...
if(isset($_POST['registration'])){
  ...
  */
  ...
  $preferredDepartmentCode=$departmentCode;
  $preferredHostel=addslashes($_POST['preferredHostel']);
  $query = "INSERT INTO Student (firstName,middleName,lastName,rollNumber,class,departmentCode,phoneNumber,emailId,hostel,degree) VALUES ('$firstName','$middleName','$lastName','$rollNumber','$class','$departmentCode','$phoneNumber','$emailId','$preferredHostel','$degree')";
  $sql = mysql_query($query) or die();
  $studentId=mysql_insert_id();
  //if($phonathon=='on'){
    $query2="INSERT INTO PhonathonVolunteer_24 (studentId,freeSlot,preferredDepartmentCode,preferredHostel,phonathon,suggestion) VALUES ('$studentId','$freeSlot','$preferredDepartmentCode','$preferredHostel','$phonathonthistime','$suggestion')";
...
?>
  <form id="student_registration" name="student_registration" action="registration.php" method="post" onSubmit="return validate()">
    ...
    <br/>
    <label>Roll Number</label><span class="asterix">*</span>
    <div class="input">
    ...
    <span class="hint">Expected Passing out year</span>
    </div>
	<label>Degree</label>
	  <div class="input">
        	<select name="degree">
    ...
    <div class="input">
      <select name="departmentCode" id="preferredDepartmentCode">
<?php
...
?>
    ...
    <div id="phonathon_interested">
      ...
      <div class="input" id="freeSlot">
        ...
        <table class="freeslot">
          <tr><th>Weekends</th>
          <th>2:00pm - 4:00pm <br>(A) </th><th> 4:00pm - 6:00pm<br> (B) </th><th> 6:00pm - 8:00pm<br> (C) </th></tr>
          <tr>
            <th>14<sup>th</sup>June</th><td><input type="checkbox" name="slot" id="14A"/></td><td><input type="checkbox" name="slot" id="14B"/></td><td><input type="checkbox" name="slot" id="14C"/></td></tr>
          <tr>
            <th>15<sup>th</sup>June</th><td><input type="checkbox" name="slot" id="15A"/></td><td><input type="checkbox" name="slot" id="15B"/></td><td><input type="checkbox" name="slot" id="15C"/></td></tr>
          <tr><th>Weekdays</th>
          <th>6:00pm - 8:00pm<br> (A) </th><th> 8:00pm - 10:00pm (B) </th></tr>
          <tr>
            <th>9<sup>th</sup>June</th><td><input type="checkbox" name="slot" id="9A"/></td><td><input type="checkbox" name="slot" id="9B"/></td></tr>
		  <tr>
            <th>10<sup>th</sup>June</th><td><input type="checkbox" name="slot" id="10A"/></td><td><input type="checkbox" name="slot" id="10B"/></td></tr>
          <tr>
            <th>11<sup>th</sup>June</th><td><input type="checkbox" name="slot" id="11A"/></td><td><input type="checkbox" name="slot" id="11B"/></td></tr>
          <tr>
            <th>12<sup>th</sup>June</th><td><input type="checkbox" name="slot" id="12A"/></td><td><input type="checkbox" name="slot" id="12B"/></td></tr>
          <tr>
            <th>13<sup>th</sup>June</th><td><input type="checkbox" name="slot" id="13A"/></td><td><input type="checkbox" name="slot" id="13B"/></td></tr>
          <tr>
            <th>16<sup>th</sup>June</th><td><input type="checkbox" name="slot" id="16A"/></td><td><input type="checkbox" name="slot" id="16B"/></td></tr>
            <tr>
            <th>17<sup>th</sup>June</th><td><input type="checkbox" name="slot" id="17A"/></td><td><input type="checkbox" name="slot" id="17B"/></td></tr>
            <tr>
            <th>18<sup>th</sup>June</th><td><input type="checkbox" name="slot" id="18A"/></td><td><input type="checkbox" name="slot" id="18B"/></td></tr>
            <tr>
            <th>19<sup>th</sup>June</th><td><input type="checkbox" name="slot" id="19A"/></td><td><input type="checkbox" name="slot" id="19B"/></td></tr>
