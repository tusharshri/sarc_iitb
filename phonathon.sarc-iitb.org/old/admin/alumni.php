<?php
	...
	$alumlist = $DBConn->get_array("SELECT firstname, middlename, lastname, PID, department, class, degree, city, country, status,mailed FROM alumnus_basicdetail NATURAL JOIN alumnus_contactdetail NATURAL JOIN allotment NATURAL JOIN calllog WHERE volunteer_id = ? ORDER BY status ASC", array($user));
?>
<html>
	<head>
