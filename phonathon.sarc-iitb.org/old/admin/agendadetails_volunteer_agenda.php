<?php
	...
	$list = $DBConn->get_array ("SELECT * FROM alumnus_basicdetail NATURAL JOIN alumnus_contactdetail NATURAL JOIN allotment NATURAL JOIN alumnus_agendaconfirmation NATURAL JOIN agenda AS v WHERE volunteer_ID=? AND agenda=?", array($volunteerID, $agenda));
?>
<html>
	<head>
