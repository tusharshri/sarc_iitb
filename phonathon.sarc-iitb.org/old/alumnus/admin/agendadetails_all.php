<?php
	...
	$list = $DBConn->get_array ("SELECT * FROM alumnus_basicdetail NATURAL JOIN alumnus_contactdetail NATURAL JOIN allotment NATURAL JOIN alumnus_agendaconfirmation NATURAL JOIN agenda NATURAL JOIN (SELECT volunteer_ID, name FROM volunteer) AS v ORDER BY date_of_confirmation, agenda");
?>
<html>
	<head>
...
?>
			<tr class="head">
				<th>Total</th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th><?php echo $num ?></th>
			</tr>
<?php
			}
?>
