<?php
	...
	$list = $DBConn->get_array ("SELECT * FROM alumnus_basicdetail NATURAL JOIN alumnus_contactdetail NATURAL JOIN allotment NATURAL JOIN alumnus_agendaconfirmation NATURAL JOIN agenda WHERE date_of_confirmation=? AND volunteer_ID=? ORDER BY agenda", array ($date, $volunteerID));
?>
<html>
	<head>
...
?>
			<tr class="head">
				<th>Total</th><th></th><th></th><th></th><th></th><th></th><th></th><th><?php echo $num ?></th>
			</tr>
<?php
			}
?>
