...
<html>
	...
	<body id="body">
		<div id="header">
            <div id="tmenu">
                <ul class="tmenu">
                    <li><a href="design.php?keepThis=true&TB_iframe=true&height=400&width=900"" title="" class="thickbox">Script</a></li>
                    <li><a >Time Zone</a></li>
                    <li><a >Add. Info</a></li>
                    <li><a >Contacts</a></li>
                </ul>
			...
			<div id="pmenu">
				<ul>
					...
					<li><a onclick="selected(2); loadPage('allotment.php')">Allottment</a></li>
					<li><a onclick="selected(3); loadPage('createvolunteer.php')">Create Volunteer</a></li>
					<li><a onclick="selected(4); loadPage('mydetails.php')">My Details</a></li>
