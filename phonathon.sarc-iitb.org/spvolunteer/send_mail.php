...
<?php
		...
		for($i=0; $i<count($agendas); $i++){
				if($agendas[$i]['agenda_id']==1){
                    ?>
				&lt;p&gt;Thank you for your continued support to IITB. (if he has shown interest in any donations) You can go <a href="http://sarc-iitb.org/alumni_navigation.php?pid=<?php echo $PID;?>&agenda=1">here</a> to make your gift to IIT Bombay. &lt;/p&gt;
				<?php
				}
				if($agendas[$i]['agenda_id']==4){
                    ?>
				&lt;p&gt;You can be a mentor to a current student by regestering <a href="http://sarc-iitb.org/alumni_navigation.php?pid=<?php echo $PID;?>&agenda=4">here</a>.&lt;/p&gt;
				<?php
				}
				
				if($agendas[$i]['agenda_id']==2){
                    ?>
                       &lt;p&gt;Your interest in offering internships to IITB students has been conveyed to the internship cell of IITB. They will follow up with you at the earliest. (if internship enthu)&lt;/p&gt;
                    <?php
                }
...
?>
&lt;p&gt;In case there is any information of yours that you would like to update in the alumni directory please visit <a href="phonathon.sarc-iitb.org/alumnus/update.php?PID=<?php echo $PID; ?>&key=<?php echo $key; ?>">this. &lt;/p&gt;
...
&lt;p&gt;We had called you to know if you would like to mentor a student of IIT Bombay. It is an initiative to help students get benefit of alumni's experience in making crucial career related decisions. Please register at <> to be a part of the mentorship program.&lt;/p&gt;
