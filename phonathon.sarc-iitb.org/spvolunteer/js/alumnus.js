...
function SubmitAgenda() {
	...
	if (agendachecklist[0].checked) to_send = "?" + agendachecklist[0].name + "=on";
	else to_send = "?arbit=off";
	for (var i=0; i < agendachecklist.length; i++) {
		if (agendachecklist[i].name != "") {
			if (agendachecklist[i].checked) {
