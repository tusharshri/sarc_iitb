				...
				<tr>
					<td>
						<?php
						  if ($status == "Ongoing") {
						?>
									  <input type="button" value="Submit" onclick="SubmitPhoneNums();">
						<?php
						  }
						?>	<br/><br/>
					</td>
...
<?php
  if ($status == "Ongoing") {
?>
              <input type="button" value="Submit" onclick="SubmitEmailIDs();">
<?php
  }
?>
            </div>
...
?>
            <tr>
              ...
              <td style="display:none;">
                                <input id="callduration" type="text" name="timeofcall" value="0" /><br/>
...
<?php
  if ($status == "Ongoing") {
?>
          <input type="button" onclick="SubmitMailInfo()" value="Submit" /><a href="send_mail_new.php">Send Mail</a>
<?php
  }
?>
          </div>
